...
//
/**
 This class is a copy from GitHub repo https://github.com/dapperstout/swift-bytes/
 by Dapperstout, http://dapperstout.com
 
 Unfortunately SwiftBytes Pod did not have tvOS target available. I left PR pending, but
 cannot wait anymore for the PR to go through, so I had to remove the dependecy for now.
 
 SwiftBytes is releasen under MIT license as stated here https://github.com/dapperstout/swift-bytes/blob/master/LICENSE.txt
 */
import Foundation
